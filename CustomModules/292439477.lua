...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		local res = game:HttpGet("https://raw.githubusercontent.com/incrimination/testing-vape-src/main/"..scripturl, true)
...
local function getcustomassetfunc(path)
	if not betterisfile(path) then
		...
		local req = requestfunc({
			Url = "https://raw.githubusercontent.com/incrimination/testing-vape-src/main/"..path:gsub("vape/assets", "assets"),
			Method = "GET"
		})
